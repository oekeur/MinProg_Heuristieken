...
def BreadthFirst(boardname):
    ...
    while (0 < Breadth_list.count):
        ...
        for car in moves1:
            ...
            elif (Breadth_cars not in Breadth_list and Breadth_cars not in List_done):
                Breadth_cars[0][5] += 1
        ...
        for car in moves2:
            ...
            # saving the list of cars if never been in this state
                ...
                Breadth_cars[0][5] += 1
                Breadth_list.append(Breadth_cars)
                if Breadth_cars in List_done:
                    print "is in"
                # time.sleep(0.100)
                # VisualizeCars(Breadth_cars)
        
        # updat iteration, remove cars from Breadth_list and add to List_done
        iteration += 1
        done = Breadth_list.popleft()
        List_done.append(done)

        # empty the moves lists
        moves1.clear()
        moves2.clear()
